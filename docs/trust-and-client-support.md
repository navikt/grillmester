...
| **OpenCode 1.x fra 1.18.20** | Deterministisk target med 8 agenter, 43 skills og 43 commands. Brukerinstallert klient startes gjennom cplt. | Hver konkret modell må kvalitetsvalideres; nyere 1.x er kompatibilitetsflate, ikke de eksakte testbytene. |
...
2. Bekreft 8 agenter og 43 skills uten kollisjoner eller døde referanser.
