...
flow, privileged operation, or new trust boundary. Mark unresolved identity,
data classification or trust-boundary facts as `NEEDS_CONTEXT`; do not treat
this framework review as security approval.
