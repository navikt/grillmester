...
class LocalModeTests(unittest.TestCase):
    ...
    def test_github_access_requires_explicit_environment_capability_for_each_client(self) -> None:
        ...
        for client, binary in (("opencode", self.opencode), ("copilot", self.copilot)):
            ...
            if client == "copilot":
                ...
                self.assertIn(
                    "--secret-env-vars=COPILOT_PROVIDER_API_KEY,GITHUB_TOKEN,COPILOT_GITHUB_TOKEN,NPM_AUTH_TOKEN",
                    child,
                )
                self.assertNotIn(
    ...
    def test_copilot_launch_binds_local_inference_and_keeps_tools_connected(self) -> None:
        ...
        self.assertIn(
            "--secret-env-vars=COPILOT_PROVIDER_API_KEY,GH_TOKEN,GITHUB_TOKEN,COPILOT_GITHUB_TOKEN,NPM_AUTH_TOKEN",
            client,
        )
    ...
    def test_local_launch_uses_empty_session_owned_npm_user_config(self) -> None:
