...
its presence in model context is the source of **Context Load**. Runtime behavior is split between portable skill metadata, explicit OpenCode
command wrappers, and ordered `permission.skill` rules.
