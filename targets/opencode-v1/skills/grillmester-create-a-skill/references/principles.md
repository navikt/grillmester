...
Keep portable skill metadata in `SKILL.md`, OpenCode slash entry points in
`commands/`, and model access in ordered `permission.skill` rules rather than
encoding invocation policy in prose.
