...
og godkjenning som allerede er gitt for oppgaven. Bruk `question` når det er
...
første skisse. Avklar målet, hvem det er for, hvilke antakelser som bærer ideen
...
Når utforskingen går over flere økter, avslutt hver økt med valgte retninger,
åpne spørsmål og neste steg. Lagre dette i en Issue med `issue-management`
bare når designeren har gitt mandat til det.
