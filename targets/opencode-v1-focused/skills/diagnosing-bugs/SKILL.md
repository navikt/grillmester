...
description: "Reproduce and diagnose a bug through a minimized symptom, ranked hypotheses and regression evidence. Use for failures, hangs, flakes or performance regressions with an unclear cause; use the repository's platform diagnostic workflow first when the missing evidence is in a deployed Nais environment."
---
# Diagnosing Bugs
...
for the reproduction and fix discipline. Use repository evidence where it is
