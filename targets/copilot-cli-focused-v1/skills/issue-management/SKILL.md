...
description: "Inspect, create, update, link or close GitHub issues for work that is already shaped. Use for tracker mechanics and explicit issue requests; use the full-context issue assessment workflow to assess readiness and the full-context plan decomposition workflow to decompose a resolved plan."
---
