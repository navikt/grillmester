...
description: "Create narrow tests through a real adapter or boundary using its public interface. Use for database, HTTP-client, message-adapter or filesystem contracts; use the repository's full-system test workflow when proving the flow requires booting the assembled application."
---
...
- Avoid full application boot; that belongs in the repository's full-system test workflow.
